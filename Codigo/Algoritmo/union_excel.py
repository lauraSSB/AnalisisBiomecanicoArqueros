...
carpeta = 'G:/Mi unidad/Videos Trabajo de Grado/Excel Kinovea T'
...
if 'LD' in carpeta:
    ...
    partes = ['tobillo_izquierdo', 'rodilla_izquierda', 'cadera_izquierda']
...
df_final.to_csv('G:/Mi unidad/Videos Trabajo de Grado/Excel Kinovea T/excel_unido.csv', index=False)
