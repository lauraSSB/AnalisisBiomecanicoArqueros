...
datos <- read_csv("C:/Users/laura/OneDrive/Documents/TrabajoGrado_LauraSalamanca/comparacion_LI_final.csv")

summary(datos$diferencia_rodilla)

ggplot(datos, aes(x = diferencia_rodilla)) +
  geom_histogram(binwidth = 1, fill = "#FFC125", color = "black") +
...
ggplot(datos, aes(x = diferencia_rodilla)) +
  geom_boxplot(fill = "#FFC125", outlier.color = "red", outlier.shape = 18, outlier.size = 3) +
...
ggplot(datos, aes(x = diferencia_pie)) +
  geom_histogram(binwidth = 1, fill = "#FFD39B", color = "black") +
  geom_vline(xintercept = 0, color = "red", linetype = "dashed", linewidth = 1) +
  xlim(-40,40) +
...
ggplot(datos, aes(x = diferencia_pie)) +
  geom_boxplot(fill = "#FFD39B", outlier.color = "red", outlier.shape = 18, outlier.size = 3) +
  geom_vline(xintercept = 0, color = "blue", linetype = "dashed", linewidth = 1) +
  labs(x = "Diferencia pie") +
  theme_minimal() +
  theme(
